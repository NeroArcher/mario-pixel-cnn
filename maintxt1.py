...
# txtmap_dataset = MyDataset(base_path)

# train_loader = torch.utils.data.DataLoader(txtmap_dataset)
    
# test_loader = torch.utils.data.DataLoader(txtmap_dataset)
...
model_name = 'mario_pcnn_lr:{:.5f}_nr-resnet{}_nr-filters{}'.format(args.lr, args.nr_resnet, args.nr_filters)
...
if 'mnist' in args.dataset : 
    ...
    train_loader = torch.utils.data.DataLoader(MyDataset(base_path,
